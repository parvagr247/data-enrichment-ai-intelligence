...
public class DefaultWebContentFetcher implements WebContentFetcher {
    ...
    private boolean isBlockedHost(String host) {
        ...
        // SSRF guard: resolve host to check for private or loopback IP ranges
        try {
            ...
            for (InetAddress addr : addresses) {
                ...
                if (raw != null) {
                    // Check IPv4 ranges: 127.0.0.0/8, 10.0.0.0/8, 192.168.0.0/16, 169.254.0.0/16, 172.16.0.0/12
                    if (raw.length == 4) {
                        int b0 = raw[0] & 0xFF;
                        int b1 = raw[1] & 0xFF;
