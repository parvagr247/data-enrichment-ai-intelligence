    ...
    public FetchedContent fetch(String url) {
        ...
        try {
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(uri)
                    .timeout(Duration.ofMillis(properties != null ? properties.readTimeoutMs() : 5000))
                    .header("User-Agent", properties != null && properties.userAgent() != null ? properties.userAgent() : "Mozilla/5.0")
