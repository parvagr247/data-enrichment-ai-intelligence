...
import com.subdual.ai_intelligent_service.service.SpringAiEnrichmentService;
...
class EnrichmentAiServiceTest {
    ...
    void setUp() {
        ...
        enrichmentService = new SpringAiEnrichmentService(Optional.empty(), properties, "mock-key");
    }
