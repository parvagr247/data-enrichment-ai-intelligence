package com.subdual.ai_intelligent_service.profile.model;
...
public record ResearchProfile(
    ...
    public record ActivityItem(
            String title,
            String activityType, // AUTHORED, LIKED, MENTIONED, RECURRING_THEME
            String summary,
            String classification, // HIRING_ANNOUNCEMENT, TECHNICAL_DISCUSSION, INTERNSHIP_POST, MENTORSHIP_GUIDANCE, LEADERSHIP_INSIGHT, GENERAL_UPDATE
            String sourceUrl
    ) {}
}
